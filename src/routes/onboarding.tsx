    ...
    <div className="min-h-screen bg-background px-6 py-12">
      <div className="mx-auto max-w-2xl">
        <div className="mb-10 text-center">
          ...
          <h1 className="font-display text-4xl">Start a new jar</h1>
        ...
        <form onSubmit={submit} className="space-y-8 rounded-3xl bg-card p-8 ring-1 ring-black/5">
              ...
              {rows.map((row, i) => (
                <div key={i} className="flex gap-2">
                  <input
                    ...
                    placeholder="Name"
                    className="flex-1 rounded-lg bg-surface px-3 py-2 text-sm ring-1 ring-black/5 focus:outline-none focus:ring-2 focus:ring-brand"
                  />
                  <input
                    value={row.email}
                  ...
                  <button
                    type="button"
                    onClick={() => removeRow(i)}
                    className="rounded-lg p-2 text-muted-foreground hover:bg-surface hover:text-brand"
